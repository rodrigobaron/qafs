...
fs = qafs.FeatureStore(connection_string='sqlite:///test.sqlite', url='/tmp/featurestore/tutorial')

fs.create_namespace('tutorial', description='Tutorial datasets')
...
df_query = fs.load_dataframe(['tutorial/numbers', 'tutorial/squared'], from_date='2021-01-01', to_date='2021-01-31')
