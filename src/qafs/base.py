...
class BaseFeatureStore(ABC):
    ...
    def __init__(self, connection_string=None, url=None, storage_options=None, backend="pandas"):
        ...
        Args:
            ...
            backend (str, optional): storage backend, see feature_store.storage.available_backends, defaults to `"pandas"`.
        """
    ...
    def update_namespace(self, name, description=None, meta={}):
    ...
    def list_features(self, name=None, namespace=None, regex=None, friendly=None):
    ...
    def update_feature(self, name, namespace=None, description=None, transform=None, meta=None):
